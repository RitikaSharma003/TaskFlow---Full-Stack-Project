...
<>
  ...
  <button className="bg-white rounded px-4 w-[100%] py-2 hover:shadow transition-all duration-300 bg-" onClick={(event)=>showEditDiv(event,data._id)}>
<div className="flex items-center justify-between flex-wrap ">
    <h1 className="text-lg font-semibold mb-2 w-full sm:w-auto text-pink-900">{data.title}</h1>
...
>
  <p>{data.priority}</p>
   ...
   <hr className="my-2" />
   <p className="text-sm text-purple-700 text-start sm:text-center text-center-373" style={{}}>{data.description} </p>
