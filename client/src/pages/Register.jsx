...
<h3 className="text-center font-semibold text-xinc-900-">Register with TaskFlow</h3>
        </div>
...
<button onClick={register} className="bg-blue-800 text-white font-semibold py-2 rounded hover:bg-blue-700 transition-all duration-300">Register</button>
